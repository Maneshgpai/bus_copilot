...
from core.quivr_core.base_config import QuivrBaseConfig
from core.quivr_core.processor.splitter import SplitterConfig
from core.quivr_core.prompts import CustomPromptsModel
...
class LLMEndpointConfig(QuivrBaseConfig):
    ...
    Attributes:
        ...
        model (str): The specific model to use (default: "gpt-4o-mini").
    ...
    supplier: DefaultModelSuppliers = DefaultModelSuppliers.ANTHROPIC
